...
def check_and_train_models():
    models_to_check = [
        'modelo_entrenado.pkl', 'scaler.pkl', 'modelo_asociacion.pkl',
        'modelo_confort.pkl', 'modelo_lluvia.pkl', 'modelo_evaporacion.pkl'
    ]
    
    # Check if ANY model is missing
    is_training_needed = any(not os.path.exists(model) for model in models_to_check)

    if is_training_needed:
        print("--- One or more models not found. Running all training scripts. ---")
        training_scripts = [
